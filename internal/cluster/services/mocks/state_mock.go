...
// Source: github.com/spoke-d/thermionic/internal/cluster/services (interfaces: State)
...
import (
	...
	services "github.com/spoke-d/thermionic/internal/cluster/services"
	reflect "reflect"
)
...
func (m *MockState) Cluster() services.Cluster {
	ret := m.ctrl.Call(m, "Cluster")
	ret0, _ := ret[0].(services.Cluster)
	return ret0
}
...
func (m *MockState) Node() services.Node {
...
func (m *MockState) OS() services.OS {
	ret := m.ctrl.Call(m, "OS")
	ret0, _ := ret[0].(services.OS)
	return ret0
}
